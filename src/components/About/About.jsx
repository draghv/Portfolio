...
export const About = () =>{
    return <section className={styles.container} id="about">
            ...
            <ul className={styles.aboutItems}>
                <li
                className={styles.aboutItem}><img src={getImageUrl('about/cursorIcon.png')} 
                alt="Cursor Icon" />
                <div
                className={styles.aboutItemText}>
                    <h3>Frontend Developer</h3>
                    <p>I'm a frontend developer with experience in building resonsive and optimised sites</p>
                </div>
                </li>
